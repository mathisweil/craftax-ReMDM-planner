...
The minihack twin is src/diffusion/loss.py:mdlm_loss.
"""
...
def compute_loss(
    ...
    # Constant per-token normalisation (1/H) per MDLM eq (10) / Shi
    # eq (4). Dividing by the realised masked count instead would distort
    # the NELBO weight by ~1/(1-alpha_t) per sample.
    H = x_0.shape[1]
