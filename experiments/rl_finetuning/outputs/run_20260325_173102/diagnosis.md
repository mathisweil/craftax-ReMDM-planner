...
**Pretrained baseline score:** 6.6000
**Baseline RL score:** 6.7666
...
- **Score:** 6.7666  (delta vs pretrained: +0.1667)
- **Hypothesis tested:** Diagnoses whether the RL signal alone causes collapse
- **Mean grad alignment:** +0.0961
- **Final KL drift:** 0.020102

### kl_penalty  [COLLAPSE]
- **Score:** 6.4500  (delta vs pretrained: -0.1500)
- **Hypothesis tested:** If this helps: catastrophic forgetting is the primary cause; soft regularisation suffices
- **Mean grad alignment:** +0.1060
- **Final KL drift:** 0.030736
